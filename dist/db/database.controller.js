...
let DatabaseController = class DatabaseController extends base_controller_1.BaseContorller {
    ...
    delete(req, res, next) {
        ...
        if (!((_a = req.body) === null || _a === void 0 ? void 0 : _a.name) && !((_b = req.body) === null || _b === void 0 ? void 0 : _b.cost) && !((_c = req.body) === null || _c === void 0 ? void 0 : _c.amount) && !((_d = req.body) === null || _d === void 0 ? void 0 : _d.id)) {
        ...
        if ((_l = req.body) === null || _l === void 0 ? void 0 : _l.id) {
            query.where('_id').equals((_m = req.body) === null || _m === void 0 ? void 0 : _m.id);
        }
        query
            .deleteMany()
            .exec()
